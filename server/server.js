...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      {method: 'GET', path: '/api/exercise2', description: 'group 127 application deployed using docker'},
 ...
 * SERVER *
 **********/
// Add API endpoint /api/exercise2
app.get('/api/exercise2', (req, res) => {
  res.send('group 127 application deployed using docker');
});
